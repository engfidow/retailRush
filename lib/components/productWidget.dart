...
import 'package:ecomerce/Models/CategoryProduct.dart';
...
class GetCategoryProduts extends StatelessWidget {
  final List<ProductCategory> products;

  GetCategoryProduts({required this.products});
                      ...
                      onPressed: () {
                        setState(() {
                          ...
                          if (widget.product.isFavorite) {
                            cartProvider.addToCart(widget.product as Product);
                          } else {
                            cartProvider
                                .removeFromCart(widget.product as Product);
                          }
                          _saveFavoriteStatus(
