...
class _VerifyCodeScreenState extends State<VerifyCodeScreen> {
  ...
  Future<void> _verifyCode() async {
    ...
    final response = await http.post(
      Uri.parse(
          'https://retailrushserver-production.up.railway.app/api/users/verify-code-update-password'),
  ...
  Future<void> _resendCode() async {
    ...
    try {
      final response = await http.post(
        Uri.parse(
            'https://retailrushserver-production.up.railway.app/api/users/send-verification-code'),
        headers: {'Content-Type': 'application/json'},
